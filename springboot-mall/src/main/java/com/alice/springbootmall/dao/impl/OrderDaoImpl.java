...
import com.alice.springbootmall.rowmapper.OrderItemRowMapper;
import com.alice.springbootmall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl  implements OrderDao {
    ...
    public void createOrderItems(Integer orderId, List<OrderItem> orderItemList) {
        ...
        //方法一：使用for loop一條一條sql加入數據，效率較低
